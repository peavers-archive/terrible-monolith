...
public class MediaFileController {
  ...
  public Flux<MediaFile> findAll(
    ...
    return mediaFileService.findAll(order).filter(mediaFile -> !mediaFile.isDelete()).take(500);
  }
  ...
  @DeleteMapping("/{id}")
  public Mono<MediaFile> deleteById(@PathVariable final String id) {

    return mediaFileService
        .findById(id)
        .doOnSuccess(mediaFile -> mediaFile.setDelete(true))
